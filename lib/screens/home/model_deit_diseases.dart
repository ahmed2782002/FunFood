...
class DiseaseDietModel {
  static final Map<String, Map<String, MealItem>> diseaseMeals = {
    ...
    'PCOS': {
      'فطور (١٠ ص - كسر الصيام)': MealItem(
          'بيضتان مسلوقتان أو أومليت بزيت الزيتون + خيار وجرجير + ربع رغيف أسمر\n'
          'أو طبق فول بزيت زيتون + قطعة جبنة قريش\n'
          '⚠️ خالي من الألبان ومشتقاتها\n'
          '☕ مسموح بالشاي أو القهوة بدون سكر والمشروبات العشبية'),
      'سناك 1 (١:٣٥ م)': MealItem(
          'ثمرة فاكهة: تفاحة صغيرة أو كمثرى\n'
          '⚠️ تجنب الفواكه عالية المؤشر الجلايسيمي مثل التين والعنب'),
      'غداء': MealItem(
          'صدر دجاج مشوي (الشواء يقلل نسبة الدهون) + ٣ ملاعق أرز مصري + طبق سلطة مضاف عليه ملعقة زيتون\n'
          'أو سمكة مشوية بديل الدجاج مع الأرز\n'
          'أو طبق عدس (في يوم آخر بديل عن الدجاج والسمك)'),
      'سناك 2 (٦ م)': MealItem('خضار فقط: خيار وجزر (٢ حبة)'),
      'عشاء (٧ م)': MealItem(
          'طبق سلطة + جبن قريش مع خيار وطماطم ورشة نعناع جاف\n'
          'أو ٣ ملاعق فول مدمس بزيت الزيتون مع ربع رغيف\n'
          '💊 مكملات: L-Carnitine قرص مرة يومياً + Limitless Conceive Q قرص مرة يومياً'),
    },
